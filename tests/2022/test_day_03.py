...
from advent_of_code.year_2022.day_03 import (part_1,
                                             part_2)
...
class TestExamples(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.enterClassContext(
            patch('advent_of_code.year_2022.day_03.part_1.get_input', side_effect=mocked_get_input))
        cls.enterClassContext(
            patch('advent_of_code.year_2022.day_03.part_2.get_input', side_effect=mocked_get_input))

        super().setUpClass()

    def test_part1(self):
        """Test if example from part 1 problem statement works"""
        priority_sum = part_1.main()
        self.assertEqual(priority_sum, 157)

    def test_part2(self):
        """Test if example from part 2 problem statement works"""
        priority_sum = part_2.main()
